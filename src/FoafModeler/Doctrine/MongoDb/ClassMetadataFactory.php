...
{
    const CACHE_NS = 'foaf_class_metadata_';
     ...
     * Metadata driver
     * 
     * @var \FoafModeler\Doctrine\MongoDb\Driver
     */
    protected $driver;
     ...
     * Get metadata driver
     * 
     * @return \FoafModeler\Doctrine\MongoDb\Driver
     */
     ...
     * @throws \Exception
     * @return \FoafModeler\Doctrine\MongoDb\ClassMetadata
     */
     ...
     * 
     * @param string $class
     * @param \FoafModeler\Doctrine\MongoDb\ClassMetadata $metadata
     */
    protected function writePhpClass($class, $metadata)
    {
        $generator = new DocumentGenerator();
        $generator->regenerateDocumentIfExists(true);
